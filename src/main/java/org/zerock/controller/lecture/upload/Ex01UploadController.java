...
public class Ex01UploadController {
	...
	public void method1(String fname, @RequestParam("ufile") MultipartFile ufile) {
		...
		String name = "/Users/yangseungju/myworkspace/tempFile" + ufile.getOriginalFilename();
	...
	public void method02(MultipartFile file) {
		...
		String localFilePath = "/Users/yangseungju/myworkspace/tempFile" + file.getOriginalFilename();
